...
# Check for ENABLE_ALL or ENABLE_ALL_BUT_ADSBX environment variables.
...
if [ $(check_true ENABLE_ALL_BUT_ADSBX) = "true" ]
then
...
then
	...
	then
        	adsb="true"
	 	mlat="true"
   		ADSB_NET_CONNECTOR+=("--net-connector=feed1.adsbexchange.com,30004,beast_reduce_plus_out,feed.adsbexchange.com,64004")
